...
from swir_image_processor import SWIRImageProcessor
...
class SWIRTimeSeriesPipelineProcessor:


    def __init__(self):

        self.parent_folder = '/home/sotgab/sysops/HIPPA/bruising/'
        self.output_path = '/home/sotgab/sysops/HIPPA/GAB/full_preprocessing_pipeline/outputs/SWIR/'
        ...
        self.img_proc = SWIRImageProcessor()
